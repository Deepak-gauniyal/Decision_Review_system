...
window = tkinter.Toplevel() # to make GUI window
window.title(" Third Umpire Decision Review System by Deepak")
canvas = tkinter.Canvas(window, width = SET_WIDTH, height= SET_HEIGHT)

cv_img = cv2.cvtColor(cv2.imread("Kotla.jpg"), cv2.COLOR_BGR2RGB)
